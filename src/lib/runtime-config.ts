...
const runtimeEnvConfig = {
  ...
  adsterraEnablePopunder: readFlag(process.env.NEXT_PUBLIC_ADSTERRA_ENABLE_POPUNDER),
  adsterraEnableSocialBar: readFlag(process.env.NEXT_PUBLIC_ADSTERRA_ENABLE_SOCIAL_BAR),
  adsterraEnableStickyRail: readFlag(process.env.NEXT_PUBLIC_ADSTERRA_ENABLE_STICKY_RAIL),
